                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.services.update', $service) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" rows="6" class="form-control" required>{{ old('description', $service->description) }}</textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        @if ($service->image)
                                            <div class="mb-2">
                                                <img src="{{ asset($service->image) }}" alt="{{ $service->title }}" style="height: 90px;">
                                            </div>
                                        @endif
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="sort_order" min="0" class="form-control" value="{{ old('sort_order', $service->sort_order) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
